  ...
  return (
    <section className="px-6 py-10">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold text-[#1e1e1e]">Popular Product</h2>
      </div>

      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        {Array.isArray(products) &&
          products.map((product, idx) => (
            <div key={idx} className="bg-white border rounded-xl shadow hover:shadow-md transition duration-200 flex flex-col justify-between cursor-pointer">
